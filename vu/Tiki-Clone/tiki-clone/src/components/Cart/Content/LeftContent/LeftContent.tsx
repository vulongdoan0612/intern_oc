...
import styles from "@/styles/Cart/CartContent/CartLeftContent/CartLeftContent.module.scss";
  ...
  const data = [
    {
      ...
      brand: "Máy Tính Bảo Minh",
      title:
        "Chuột không dây Bluetooth 5.0 Dareu LM115B + Wireless 2.4GHz ( Silent Switch ) - Hàng chính hãng - Đen",
      svgTrash:
        "https://frontend.tikicdn.com/_desktop-next/static/img/icons/trash.svg",
      price: "233.000 ₫",
    },
    {
      img: "https://salt.tikicdn.com/ts/upload/30/24/79/8317b36e87e7c0920e33de0ab5c21b62.png",
    ...
    <div className={styles.wrapper}>
      <div className={styles.heading}>
        <label className={styles.styledCheckBox}>
          ...
          />
          <span className={styles.label}>Tất cả (7 sản phẩm)</span>
        </label>
        <span>Đơn giá</span>
        <span>Số lượng</span>
      ...
      <div className={styles.container}>
        {data.map((product) => {
          return (
            <div className={styles.styledSeller}>
              ...
              <div className={styles.sellerSuggestion}>
                <div className={styles.suggestList}>
                  <div className={styles.suggestListContent}>
                    <p>Để nhận Freeship 20K</p>
                    <a>
                      <span>Mua thêm 66K</span>
                    </a>
                  </div>
                </div>
              </div>
              <div className={styles.sellerProduct}>
                <div className={styles.sellerRow}>
                  <div className={styles.sellerCol1}>
                    <div className={styles.sellerLeftItem}>
                      <div className={styles.sellerCheckBoxItem}>
                        <label className={styles.styledCheckBox2}>
                          <Checkbox
                            checked={checked2}
                            onChange={handleChange2}
                            inputProps={{ "aria-label": "controlled" }}
                      ...
                      <div className={styles.sellerContentProduct}>
                        ...
                        <div className={styles.sellerAsa}>
                          <svg
                            width="16"
                            height="16"
                            viewBox="0 0 20 20"
                  ...
                  <div className={styles.sellerCol2}>
                    <span className={styles.sellerPrice}>{product.price}</span>
                  </div>

                  <div className={styles.sellerCol3}>
                    {" "}
                  ...
                  <div className={styles.sellerCol4}>
